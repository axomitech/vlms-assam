                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="hidden" class="form-control"
                                                                    ...
                                                                    value="{{ $letterData['other_sub_category'] }}">
                                                                <label
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    id="ecr_no" value="{{ $letterData['ecr_no'] }}">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input type="text" name="sender_designation"
                                                                        ...
                                                                        value="{{ $letterData['sender_designation'] }}">
                                                                    <label
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input type="text" name="recipient_designation"
                                                                        ...
                                                                        class="form-control form-control-sm"
                                                                        placeholder="eg. Home Secretary"
                                                                        value="{{ $letterData['recipient_designation'] }}">
                                                                    <label
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input type="text" name="recipient_mobile"
                                                                        ...
                                                                        class="form-control form-control-sm"
                                                                        placeholder="eg. 7020541234"
                                                                        value="{{ $letterData['recipient_phone'] }}">
                                                                    <label
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input type="text" name="recipient_email"
                                                                        ...
                                                                        class="form-control form-control-sm"
                                                                        placeholder="eg. assam@gov.in"
                                                                        value="{{ $letterData['recipient_email'] }}">
                                                                    <label
                                                        ...
                                                        <div class="row">
                                                            @if ($letterData['receipt'] != 1)
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <label
                                                                        class="text text-danger address fw-bold"></label>
                                                                </div>
                                                            @endif
                                                            @if ($letterData['receipt'] == 1)
                                                                <div class="col-md-12">
                                                                    <label class="form-label fw-bold">Office
                                                                        Details111<span
                                                                            class="text text-danger fw-bold">*</span></label>
                                                                    <textarea class="form-control form-control-sm" name="organization" id="organization"
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <button type="button"
                                                                    ...
                                                                    id="save-letter-btn"
                                                                    data-redirect="{{ route('letters', [encrypt(0)]) }}">DIARIZE</button>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12" style="height:29rem;">
                                            <div class="fileContent" id="preview">
                                                <iframe class="w-100" style="height:32rem"
                                                    src="{{ storageUrl($letterData['letter_path']) }}">
                                                </iframe>
                                            </div>
                                        </div>
                                    </div>
