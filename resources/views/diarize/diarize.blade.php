                                    ...
                                    <div class="col-md-12">
                                        <form id="letter-form">
                                            ...
                                            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                                <li class="nav-item">
                                                  <a class="nav-link active active-link" id="custom-tabs-one-home-tab" data-toggle="pill" href="#custom-tabs-one-home" role="tab" aria-controls="custom-tabs-one-home" aria-selected="true">Letter Details</a>
                                                </li>
                                                <li class="nav-item">
                                                  <a class="nav-link disabled disabled-link" id="custom-tabs-one-profile-tab" data-toggle="pill" href="#custom-tabs-one-profile" role="tab" aria-controls="custom-tabs-one-profile" aria-selected="false">Sender Details</a>
                                                </li>
                                            </ul>
                                            <div class="tab-content" id="custom-tabs-one-tabContent">
                                                <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" name="letter_no" id="letter_no" class="form-control form-control-sm">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="date" name="letter_date" id="letter_date" class="form-control form-control-sm">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <input type="file" name="letter" id="letter" class="form-control form-control-sm">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="date" name="received_date" id="received_date" class="form-control form-control-sm">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="date" name="diary_date" id="diary_date" class="form-control form-control-sm" value="{{\Carbon\Carbon::now()->format('Y-m-d')}}" readonly>
                                                ...
                                                <div class="tab-pane fade" id="custom-tabs-one-profile" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <label class="form-label fw-bold">Name<span class="text text-danger fw-bold">*</span></label>
                                                            <input type="text" name="sender_name" id="sender_name" class="form-control form-control-sm" placeholder=" Name of a person">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" name="sender_designation" id="sender_designation" class="form-control form-control-sm" placeholder="eg. Home Secretary">
                                                            <label class="text text-danger sender_designation fw-bold"></label>
                                                        </div>    
                                                    
                                                        <div class="col-md-6">
                                                            <label class="form-label fw-bold">Mobile<span class="text text-danger fw-bold">*</span></label>
                                                            <input type="text" name="sender_mobile" id="sender_mobile" class="form-control form-control-sm" placeholder="eg. 7020541234">
                                                            <label class="text text-danger sender_mobile fw-bold"></label>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="form-label fw-bold">Email<span class="text text-danger fw-bold">*</span></label>
                                                            <input type="text" name="sender_email" id="sender_email" class="form-control form-control-sm" placeholder="eg. assam@gov.in">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <textarea class="form-control form-control-sm" name="organization" id="organization" placeholder="eg. Assam Secretariat"></textarea>
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <textarea class="form-control form-control-sm" name="address" id=address" placeholder="eg. Dispur, Guwahati, Kamrup(M), Assam-781019"></textarea>
                                                            <label class="text text-danger address fw-bold"></label>
                                                        </div>    
                                                        <div class="col-md-12">
                                                            
                                                            <label for="auto-ack" class="ml-4 form-label fw-bold"><input class="form-check-input" type="checkbox" value="1" id="auto-ack" name="auto_ack">&nbsp;Auto Generate Acknowledgement</label>
                                                        
                                                        </div>
                                                       <div class="col-md-6">
                                                        <button type="button" class="btn btn-warning btn-sm" data-target="#custom-tabs-one-home" id="btn-prev">PREVIOUS</button>
                                                        &nbsp;
                                                        <button type="button" class="btn btn-primary save-btn btn-sm" data-url="{{ route('store_letter') }}" data-form="#letter-form" data-message="That you want to diarize this letter!" id="save-letter-btn">DIARIZE</button>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <!-- Main row -->
                                 <div class="row">
                                    <div class="col-md-12" style="height:29rem;">
                                        <div class="fileContent"><h5 class="text text-warning mt-5 text-center">Please upload the letter for viewing.</h5></div>
                                    </div>
                                 </div>
                                <!-- Main row -->
                            </div><!-- /.container-fluid -->
