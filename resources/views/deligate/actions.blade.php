      ...
      <div class="card-header">
        <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
          ...
          <li class="nav-item" disabled>
            <a class="nav-link" id="custom-tabs-four-profile-tab" data-toggle="pill" href="#custom-tabs-four-profile" role="tab" aria-controls="custom-tabs-four-profile" aria-selected="false">Forward</a>
          </li>
          <li class="nav-item">
      ...
      <div class="card-body">
        <div class="tab-content" id="custom-tabs-four-tabContent">
          <div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
            <div style="overflow-x:auto; width: 30rem;">
              <table class="table table-sm table-striped" id="letter-table">
                <thead>
                    <tr>
                        <th>Description</th><th>Registered Date</th><th>Department</th><th>Status</th><th>Responses</th>
                    </tr>
                </thead>
                <tbody>
                    @php
