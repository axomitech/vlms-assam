...
<body>
        <div class="container-fluid bg-primary hero-header mb-1">
         ...
         <div class="col-lg-3">
                 <img class="img-fluid" src="{{ asset('banoshree/images/bg.png') }}" alt=""></div>
            <div class="col-lg-9 text-center text-lg-start">
                     <div class="row">
                         <div class=" offset-lg-3 col-lg-6">
                     <h3 class="fw-light text-white animated slideInRight">Government of Assam</h3>
                     <h1 class="display-4 text-white animated slideInRight">VIP  <span class="fw-light text-dark">Letter<sup><img src="{{ asset('banoshree/images/letter_sent.png') }}" alt="VIP Letter Management System" height="40"></sup></span> Management System</h1>
                     <p class="text-white mb-4 animated slideInRight">Steamlining Correspondance in the Assam Secretariat</p>
                     <a href="{{ route('login') }}" class="btn btn-dark py-2 px-4 me-3 animated slideInRight"><i class="bi bi-lock"></i> Login with Parichay <i class="bi bi-arrow-right"></i> </a>
                 </div> 
             </div>
            </div>
       </div>
             ...
             <div class="copyright">
                 <div class="row">
                     <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                         ...
                         Designed & Developed by <a class="border-bottom" href="https://assam.nic.in">National Informatics Centre, Assam</a> </div>
                     <div class="col-md-6 text-center text-md-end">
                         <div class="footer-menu">
                             &copy; <a class="border-bottom" href="#">2024. CM Secretariat, Government of Assam</a>. All Right Reserved.
                         </div>
                     </div>
                 </div>
             </div>
