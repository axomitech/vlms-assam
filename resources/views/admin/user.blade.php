...
@section('content')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 text-right">
                                    <button type="button" class="btn btn-sm" style="background-color: #173f5f;color: white;"
                                        id="btn-modal" data-toggle="modal" data-target="addCorrespondenceModal">Add<i
                                            ...
                                            <table class="table table-sm table-hover table-striped" id="letter-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($results as $value)
                                                        <tr>
                                                            <td>{{ $i }}. &nbsp;{{ $value->u_name }}</td>
                                                            <td>{{ $value->u_email }}</td>
                                                            <td>{{ $value->department_name }}</td>
                                                            <td>{{ $value->role_name }}</td>
                                                            <td><a href="" class="action-link"><i class="fas fa-edit"
    ...
    <div class="modal fade" id="addCorrespondenceModal" tabindex="-1" role="dialog"
        aria-labelledby="addCorrespondenceModalTitle" aria-hidden="true">
                            ...
                            <form id="uploadForm" class="form-horizontal">
                                ...
                                <div class="row mt-5">
                                    <div class=" text-center col-md-12">
                                        <button type="button" class="btn btn-primary save-btn btn-sm "
                                            data-url="{{ route('store_correspondence') }}" data-form="#uploadForm"
                                            id="uploadBtn" data-message="Do you want to upload?"
                                            style="background-color: #173f5f;color: white;">Submit</button>
